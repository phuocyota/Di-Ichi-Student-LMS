...
function DueCard({ title, subtitle, icon: Icon, tone, action, to }) {
  ...
  return (
    <Card>
      ...
      <NavLink to={to} className={`mt-6 inline-flex rounded-3xl ${button} px-5 py-3 font-black text-white shadow-lg transition hover:-translate-y-1`}>
        {action}
      </NavLink>
    </Card>
  );
